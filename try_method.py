...
for region_name, region_acronyms in region_groups.items():
    ...
    for model_name, model in models.items():
        ...
        plt.xlabel("Predicted Probability / Score of Lick")
...
results_df.to_csv("all_classification_model_comparison_results.csv", index=False)
all_predictions_df.to_csv("all_classification_model_test_predictions.csv", index=False)
...
plt.title("Lick Decoding AUC Across Classification Models")
...
plt.ylabel("Accuracy")
plt.xlabel("Brain Region")
plt.title("Lick Decoding Accuracy Across Classification Models")
plt.xticks(rotation=30)
plt.legend()
plt.tight_layout()
plt.show()
